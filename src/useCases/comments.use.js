...
async function addComment(newComment, userCurrent = '634386c6d813421c767eb39b'){
    ...
    let commentCreated = await PostComment.create({...newComment, author: userCurrent})
    await Post.findByIdAndUpdate(newComment.post_id, {$push:{comments:commentCreated._id}}).populate('comment')
